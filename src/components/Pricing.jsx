		...
		<div className='max-w-[1240px] mx-auto py-12 text-center'>
			<div className='py-8 text-slate-300'>
				...
				<p>
					...
					optio reiciendis, autem sed impedit fugiat similique expedita libero
					cumque!
				</p>
			</div>
			<div className='grid md:grid-cols-2'>
				<div
					...
					data-aos='fade-right'
				>
					<span className='upercase px-3 py-1 bg-indigo-200 text-indego-900 rounded-2xl text-sm '>
						Standard
					</span>
					<div>
					...
					<p className='text-2xl py-8 text-slate-500'>
						...
						ullam repudiandae officia alias possimus similique veniam eum ipsa
						odit ex debitis esse sint, tenetur, accusamus reprehenderit. Numquam
						ullam nihil assumenda!
					</p>
					...
					<div className='text-2xl' data-aos='slide-up'>
						...
						<button
							type='button'
							className='w-full py-4 my-4 text-white border bg-indigo-600  rounded-md'
						>
							Get Started
						</button>
					</div>
